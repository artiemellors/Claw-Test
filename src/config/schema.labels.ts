...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.llmRecall": "LLM Memory Recall",
  "agents.defaults.memorySearch.llmRecall.enabled": "LLM Memory Recall Enabled",
  "agents.defaults.memorySearch.llmRecall.model": "LLM Memory Recall Model",
  "agents.defaults.memorySearch.llmRecall.baseUrl": "LLM Memory Recall Base URL",
  "agents.defaults.memorySearch.llmRecall.apiKey": "LLM Memory Recall API Key",
  "agents.defaults.memorySearch.llmRecall.maxFiles": "LLM Memory Recall Max Files",
  "agents.defaults.memorySearch.llmRecall.maxTokens": "LLM Memory Recall Max Tokens",
  memory: "Memory",
