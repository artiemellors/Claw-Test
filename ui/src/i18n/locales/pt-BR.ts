...
export const pt_BR: TranslationMap = {
  ...
  skillsPage: {
    title: "Habilidades",
    subtitle: "Habilidades instaladas e seus status.",
    loading: "Carregando…",
    searchPlaceholder: "Filtrar habilidades instaladas",
    shownCount: "{count} exibidas",
    clawHubTitle: "ClawHub",
    clawHubSubtitle: "Pesquise e instale habilidades do registro",
    clawHubSearchPlaceholder: "Pesquisar habilidades no ClawHub…",
    clawHubSearching: "Pesquisando…",
    notConnected: "Não conectado ao gateway.",
    noSkillsFound: "Nenhuma habilidade encontrada.",
    noClawHubSkillsFound: "Nenhuma habilidade encontrada no ClawHub.",
    install: "Instalar",
